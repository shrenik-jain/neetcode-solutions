...
class Solution:
    def merge(self, intervals: List[List[int]]) -> List[List[int]]:
        ...
        '''
        Whenever we find two overlapping intervals, we need to merge them as -
        ...
        By sorting, one of the condition of overlap is already satisfied -> i2[1] >= i1[0] 
        (the second condition for merging!)
